                    ...
                    'toolbar': [
                      {
                        group: [
                          ...
                          {
                            'name': 'deleteRow', 'class': 'editable-add-btn', 'text': '删除', 'action': 'DELETE','cancelPermission': true,
                            'ajaxConfig': {
                              delete: [{
                                'actionName': 'delete',
                                'url': 'common/WfVersion',
                          ...
                          {
                            'name': 'saveRow', 'class': 'editable-add-btn', 'text': '保存', 'action': 'SAVE', 'cancelPermission': true,
                            'type': 'method/action',
                            'ajaxConfig': {
                              post: [{
                                'actionName': 'add',
                    ...
                    'select': [
                      {
                        ...
                        config: {
                          ...
                          selectGrid: {
                            ...
                            'showTotal': true, // 是否显示总数据量
                            'pageSize': 5, // 默pageSizeOptions认每页数据条数
                            'is_SelectGrid': true,  // 【弹出表格时用】弹出表格值为true

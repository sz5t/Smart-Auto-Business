...
@Component({
  ...
  styleUrls: ['./wf-dashboard.component.css', '../../../../../node_modules/@antv/g6-editor/build/base.css'],
  encapsulation: ViewEncapsulation.Emulated
})
export class WfDashboardComponent extends CnComponentBase implements OnInit {
  ...
  public ngAfterViewInit() {
    ...
    //  this.editor.add(itempannel);  // 左边
    //  this.editor.add(detailpannel); // 右边

...
export class BsnTagComponent extends CnComponentBase implements OnInit, OnDestroy {
    ...
    public _valuetext
    public _value
    constructor(@Inject(BSN_COMPONENT_CASCADE) private cascadeEvents: Observable<BsnComponentMessage>, private cacheService: CacheService, private _http: ApiService) {
        super()
    }

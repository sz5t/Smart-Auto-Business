...
@Component({
  selector: 'cn-form-select-custom-multiple',
  templateUrl: './cn-form-select-custom-multiple.component.html',
  styleUrls: ['./cn-form-select-custom-multiple.component.css']
})
export class CnFormSelectCustomMultipleComponent extends CnComponentBase implements OnInit {
  @Input() public config;
  @Input() public value;
